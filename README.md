...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/r-caretensemble-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=14419&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/r-caretensemble-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `r-caretensemble` can be installed with:

```
conda install r-caretensemble
```

It is possible to list all of the versions of `r-caretensemble` available on your platform with:
